...
**392 tests across 22 suites** (`nix-unit --flake ./ci#tests` ⇒ `392/392 successful`, `a7c55d9`) —
`arg-env`, `compose`, `contract`, `crossing-adapter`,
